    ...
    <header className={`hdr ${tab === "cockpit" ? "is-dash" : "is-sub"}`}>
      ...
      <div className="hdr-top">
        <span className="hdr-brand">
          ...
          <span className="eyebrow">Cockpit de pilotage <span className="hdr-build" title="Version du code en ligne">BUILD stable-v67</span></span>
        </span>
      ...
      <div className="hdr-headline">
        ...
        <div className="src">{source ? `Source : ${source}` : "Chargement…"}<br />Données au {when} <span className="hdr-build hdr-build-src" title="Version du code en ligne">BUILD stable-v67</span></div>
      </div>
