    ...
    <header className={`hdr ${tab === "cockpit" ? "is-dash" : "is-sub"}`} data-tauri-drag-region>
      ...
      <div className="hdr-top" data-tauri-drag-region>
        <span className="hdr-brand" data-tauri-drag-region>
          ...
          <span className="eyebrow">Cockpit de pilotage <span className="hdr-build" title="Version du code en ligne">BUILD stable-v151</span></span>
        </span>
      ...
      <div className="hdr-headline" data-tauri-drag-region>
        ...
        <div className="src">{source ? `Source : ${source}` : "Chargement…"}<br />Données Jira au {when} <span className="hdr-build hdr-build-src" title="Version du code en ligne">BUILD stable-v151</span></div>
      </div>
